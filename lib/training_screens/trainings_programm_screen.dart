...
class _TrainingsProgrammScreenState extends State<TrainingsProgrammScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return myGoal.trainingsProgramms.isEmpty ? const LoadingWidget(): Scaffold(
      body: Column(
        children: [
          ///Talk to AI Button
          Padding(
            ...
            child: Row(
              ...
              children: [
                ShadowIconButtonWidget(buttonIcon: Icons.surround_sound_outlined, onPressFunction: (){})
              ],
            ),
          ),
  ...
  void getAndUpdateSelectedPlan(TrainingsProgramms trainingsProgramm) {
