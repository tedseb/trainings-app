...
class Styles {
  ...
  static const Color gymionText = Color(0xFF333333);
  ...
  static TextStyle get zahlen => const TextStyle(
        color: gymionText,
        fontWeight: FontWeight.w600,
        fontSize: 35.01,
      );
  ...
  static TextStyle get fliessText => const TextStyle(
        color: gymionText,
        fontWeight: FontWeight.w400,
        fontSize: 20,
      );
  ...
  static TextStyle get kleinText => const TextStyle(
        color: gymionText,
        fontWeight: FontWeight.w400,
        fontSize: 16,
      );
